const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-secondary mb-6">About Shop African Brand</h1>
      <p className="text-gray-600 mb-4">
        Shop African Brand is your premier destination for authentic African crafts, connecting artisans
